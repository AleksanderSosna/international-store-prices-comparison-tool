  ...
  return (
    <div id="stores-selection">
      <div className="columns is-mobile is-variable is-1">
        ...
        <div
          className="column has-text-left is-two-quarters has-background-white-ter"
        ...
        <div className="column has-text-left">
          <div className="p-2 has-background-white-ter">
            ...
            <h6 className="subtitle is-6 has-text-centered">
              availability of products will be shown on result cards for
              selected stores
            </h6>
            <div className="column has-text-left">
              {countriesWithStores.map((countrysWithStores, i) => (
                <CountryStoreSelect
                  country={countrysWithStores.country}
                  stores={countrysWithStores.stores}
                />
              ))}
            </div>
          </div>
