...
const Price = (props: any) => {
  ...
  if (!props.price.price) {
    return (
      <div
        id={props.price.countryCode + "-price"}
  ...
  const priceTextContent = () => {
    if (props.price.calculatedPrice) {
      return `${country(props.price.countryCode)}: ${
        props.price.calculatedPrice
      } ${selectedCurrency}`;
    } else {
      return `${country(props.price.countryCode)}: ${
        props.price.price
          ...
          <span>
            {
              props.price.availabilities.filter((avlblt: any) => {
                return (
                  ...
                  selectedStores.filter((selectedStore) => {
                    return (
                      selectedStore.countryCode === props.price.countryCode
                    );
                  })[0].storeId
                );
              })[0].quantity
  ...
  const restockComponent = () => {
    if (
      ...
      if (
        ...
        const restockTextContent = props.price.availabilities.filter(
          (avlblt: any) => {
            return (
              avlblt.storeId ===
              selectedStores.filter((selectedStore) => {
        ...
        return (
          <span
            data-tooltip-id={props.price.countryCode + "-restock-tooltip"}
